...
//  Maps_for_IOS
//
//  Created by Archeebald on 9.12.2020.
//
...
class MapVC: UIViewController, CLLocationManagerDelegate, MKMapViewDelegate {
    ...
    func mapView(_ mapView: MKMapView, viewFor annotation: MKAnnotation) -> MKAnnotationView? {
        if annotation.coordinate.latitude != mapView.userLocation.coordinate.latitude && annotation.coordinate.longitude !=
            ...
            let marker = MKMarkerAnnotationView(annotaion: annotation, reuseIdentifier: "marker")
    ...
    fonc pointsPositisionalCollege(){
        
        let arrayLat = [55.818173, 55.844996, 55.860595, 55.860337]
